...
"""
from tipfy import NotFound, Response, url_for, redirect_to
...
class PasteNewHandler(PasteBaseHandler):
    ...
    def post(self, **kwargs):
        self.form = PasteForm(self.request.form)
        ...
        if self.form.validate():
            ...
            language_code = self.request.form.get('language')
            code_raw = self.request.form.get('code', u'')
